...
class ExtractTextInfoFromPDF:
    def __init__(self):
        try:
            file = open('./Adobe Extract API Sample.pdf', 'rb')
            input_stream = file.read()
            file.close()

            # Initial setup, create credentials instance
            credentials = ServicePrincipalCredentials(
                client_id=os.getenv('e8c26e4c3cd249478eac3e62e8c951e1'),
                client_secret=os.getenv('p8e-lxCa3ZQWOK1HRu72ZMgHIhsFa_Jqi4Fb')
            )
